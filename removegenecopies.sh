...
python $BIN/removegenecopies.py . 0.75 r0_75.tree -s 22 -ncores $NSLOTS
...
python $BIN/removegenecopies.py -mk byindividual -ist 0.2 -itmin 0 -itmax 1 . 0.75 r1_75.tree -s 22 -ncores $NSLOTS
